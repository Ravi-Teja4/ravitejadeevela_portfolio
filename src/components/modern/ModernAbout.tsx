          ...
          <div data-aos="fade-right" data-aos-delay="200" className="space-y-6">
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                through academic projects, a professional internship, and freelance work.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Proficient in AWS services including EC2, S3, RDS, Lambda, CloudFront, Route 53, and 
                AWS Machine Learning services such as Rekognition, Comprehend, Textract, Lex, and Transcribe. 
                Skilled in IaC using Terraform, serverless deployment, cloud security, and database management.
              </p>
            </div>
